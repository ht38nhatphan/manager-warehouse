...
namespace test1.addformkhac
{
    public partial class product : Form
    {
        ...
        public bool cheakinput = false,cheak  = true;
        private dataservices mydatasevices;
        private DataTable mydatatable;
        public string productname;
        public string namecategory, nameunit, namesupplier;
        ...
        private void btsearch_Click(object sender, EventArgs e)
        {
            ...
            DataTable tb;
            string sql;
            sql = string.Format("select a.ProductName,b.CategoryName,d.CompanyName,c.NameUnit,a.Description from Products a join Categories b on a.CategoryID = b.CategoryID join Unit c on c.UnitID = a.UnitID join Suppliers d on d.SupplierID = a.SupplierID where {0} like N'{1}%'", producta, txtinput.Text);
        ...
        //click vào dữ liệu chuyển sang form add_input
        ...
        //lưu dữ liệu cho các biến khi click vào
